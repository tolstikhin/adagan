...
flags = tf.app.flags
flags.DEFINE_float("g_learning_rate", 0.0004,
                   "Learning rate for Generator optimizers [4e-4]")
...
def main():
    ...
    opts['mnist3_dataset_size'] = 64 * 25 # 64 * 2500
    ...
    opts['samples_per_component'] = 3000 # 50000
